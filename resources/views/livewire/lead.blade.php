            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-md font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Leads</a>
                    </div>
                </li>
            </ol>
        </div>
...
<div class="container mx-auto p-4">
    ...
    @if($leads && $leads->count() > 0)
        ...
        <div class="relative overflow-x-auto  sm:rounded-lg shadow-md py-4 border-gray-100 border">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                @foreach($leads as $lead)
                    ...
                    <td class="px-6 py-4">
                        <button wire:click="edit({{ $lead->id }})" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                            Edit
                        </button>
                        <button wire:click="delete({{ $lead->id }})" class="font-medium text-red-600 dark:text-red-500 hover:underline">
                            Delete
                        </button>
                    </td>
                </tr>
